...
内容としては、このRSMのdirectional falloffとアルベド情報に対しミップマップをかけ2 * 2画像を用意し、この情報をサンプリングポジション画像に適用し、しれぶい￥重要度サンプリングを行う  


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQzNTAwNTg0LDQwMTg3MDQ4OSwxNjkzMj
U3NDA1LC0zNTY1ODgzMjldfQ==
-->